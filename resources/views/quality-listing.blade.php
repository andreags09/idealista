...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container mt-5">
        <div class="row">
            <h3 class="card-title align-items-start flex-column">Listado de calidad</h3>
        </div>
        @foreach($ads as $ad)
            ...
            <div class="row text-left mb-5">
                ...
                <div class="col-md-3">Irrelevante desde</div>
                <div class="col-md-3">{{ $ad->irrelevantSince() }}</div>
            </div>
        @endforeach
    </div>
    </body>
